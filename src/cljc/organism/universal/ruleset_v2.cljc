...
;; ── V3 game presets (rules as programs) ───────────────────────────────────────
...
(def go-v3
  {:name "Go (v3)"
   ...
   :ruleset {:version "v3"
             :schema {:topology_type "square" :topology_size 7
...
(def organism-v3
  {:name "Organism (v3)"
   ...
   :ruleset {:version "v3"
             :schema {:topology_type "radial" :topology_size 5 :topology_symmetry 5
...
(def discovered-v3-games [go-v3 organism-v3])
