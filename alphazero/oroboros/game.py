"""Universal game engine: interprets RuleSet programs.
...
from alphazero.games.base import Game as BaseGame
...
class Game(BaseGame):
    """A game defined by a RuleSet program."""
    ...
    @property
    def name(self) -> str:
        return f"game_{self.rs.short_id()}"
